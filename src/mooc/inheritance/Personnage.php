...
class Personnage
{
    ...
    public function __construct($donnees = array())
    {
        if (!empty($donnees)) {
            ...
            throw new Exception('Missing Personnage details');
        }
    }
    ...
    public function __toString()
    {
        $id = $this->id();
        $nom = $this->nom();
        $forcePerso = $this->forcePerso();
        return "id: $id nom: $nom forcePerso: $forcePerso \n";
    }
    ...
    public function hydrate(array $donnees)
    {
        foreach ($donnees as $key => $value) {
            $method = 'set' . ucfirst($key);  // concatenate with .
